    ...
    def seed_data(self):
        ...
        courses_data = [
            ...
            },
            {
                ...
                "slug": "csharp-dotnet",
                "description": "Освойте C# и .NET для создания мощных корпоративных пр��ложений! Изучите основы языка C# и платформы .NET.",
                "icon_type": "csharp",
                "level": "beginner",
                "duration": "8-12 месяцев",
                "featured": True,
            ...
            },
            {
                ...
                "description": "Специализированный курс Python для корпоративных аналитиков. Научитесь обрабатывать и визуализировать данные.",
                "icon_type": "python",
                "level": "intermediate",
                "duration": "3-4 месяца",
                "featured": True,
