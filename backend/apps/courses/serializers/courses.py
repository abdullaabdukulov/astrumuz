...
from courses.models import CourseCategory, Course, CourseOutcome
...
class CourseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = [
            'id', 'title', 'slug', 'description', 'icon', 'icon_type',
            'level', 'duration', 'featured', 'is_new', 'category', 'category_name'
        ]
...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'title', 'slug', 'description', 'icon', 'icon_type',
            'level', 'duration', 'featured', 'is_new', 'category', 'category_name',
            'what_will_learn', 'video_hours', 'coding_exercises', 'articles', 'has_certificate',
            'outcomes', 'mentors', 'companies', 'testimonials', 'related_courses'
        ]
    ...
    def get_related_courses(self, obj):
        ...
        related = Course.objects.filter(category=obj.category).exclude(id=obj.id)[:3]
